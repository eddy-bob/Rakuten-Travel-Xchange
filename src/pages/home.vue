      ...
      showFullMeal() {
         if (this.mealPlan === this.mealPlan1) {
            ...
            this.mealPlan = this.mealPlan.filter((value, i) => {
               if (i < 2) {
                  arr.push(value);
                  this.mealPlanLength = `show ${
                     this.mealPlan1.length - 2
                  } more`;
...
<template>
   <div class="relative">
      ...
      <div class="lg:space-x-2 flex min-h-screen lg:mt-4 lg:px-20">
         <!--  -->
         <div class="space-y-1 pb-28 hidden lg:block">
            <!-- sidebar hidden on small menu -->
            <section class="relative h-24">
               <img src="/map-bg.jpeg" alt="map" class="w-full h-full" />
               <button
                  class="
                     font-extrabold
                     absolute
            ...
            <!--  -->
            <section
               class="rounded-md text-xs shadow-md p-3 space-y-6 bg-white"
            >
          ...
          />
            ...
            <!--  -->
            <section class="text-xs bg-white rounded-lg py-3 px-2 space-y-2">
               <p class="font-extrabold">Hotel name</p>
               <div
                  class="w-full bg-white px-2 flex space-x-1 border rounded-lg"
               >
                  <input
                     type="text"
                     placeholder="eg.HIlton ibis.."
                     class="
                        py-3
                        w-full
                        text-rakuttenGrey
         ...
         <div class="w-full min-h-screen flex flex-col justify-between pb-4">
            ...
            <div class="lg:space-y-2" v-else>
               ...
               <!-- filter bar for large screen hide on large screen -->
               <div class="lg:flex space-x-1 text-rakuttenGrey text-xs hidden">
                  <div
                     class="
                        w-full
                        bg-rakuteenSecondBlue
               ...
               <!-- end of filter for large screen -->
               <!-- start of filter for small screen -->
               <div class="">
                  <div
                     class="flex space-x-3 bg-white border py-2 px-3 lg:hidden"
                  >
                     <svg
                        width="16"
                        height="16"
               ...
               <!-- end of filter for small screen -->

               <!-- start or drop down available only in small screen -->
               <div class="px-3 lg:hidden block">
                  <div
                     ...
                     "
                  >
                     <select class="focus:outline-none outline-none">
                     ...
                     <span>
                        <svg
                           ...
                           class="mt-1"
                        >
                           <path d="M0 0L4 5L8 0H0Z" fill="white" /></svg
                     ></span>
                  </div>
               </div>
                     ...
                     >
                        <div class="grid grid-cols-1">
                           ...
                           <div class="grid grid-cols-5">
                              <div
                                 v-for="(photo, i) in result.property.gallery"
                                 :key="i"
                              >
                                 <img
                                    :src="addPhoto(photo)"
                        ...
                        >
                           <div class="space-y-2">
                              ...
                              <div
                                 class="lg:space-x-1 lg:flex hidden lg:relative"
                              >
                                 <div>
                                    <button
                                       class="
                              ...
                              <div class="lg:flex lg:space-x-2 hidden">
                                 ...
                                 >
                                    <path
                                       d="M6.50012 11H4.00012V8H6.50012V5.5H9.50012V8H12.0001V11H9.50012V13.5H6.50012V11ZM8.00012 0L0.00012207 3V9.09C0.00012207 14.14 3.41012 18.85 8.00012 20C12.5901 18.85 16.0001 14.14 16.0001 9.09V3L8.00012 0Z"
                                       fill="#002D63"
                                    />
                                 </svg>
                           ...
                           >
                              <div class="hidden lg:block">
                                 <img
                                    src="/TY-score-widget-transparent.png"
                                    alt=""
                                 />
                              </div>
                              <div
                              ...
                              >
                                 <div
                                    ...
                                    v-if="
                                       ...
                                       result.packages[0]?.adjustedDisplayRate
                                          .value
                                    "
                                 >
                                    <button
                  ...
                  <p>
                     ...
                     >
                        <path
                           ...
                           fill-rule="evenodd"
                           clip-rule="evenodd"
                           d="M5 0L6.25 1.25L2.5 5L6.25 8.75L5 10L0 5L5 0Z"
                           fill="#002D63"
                        />
                     </svg>
                  </p>
                  ...
                  <p>
                     ...
                     >
                        <path
                           fill-rule="evenodd"
                           clip-rule="evenodd"
                           d="M1.5 10L0.25 8.75L4 5L0.250001 1.25L1.5 -4.37114e-07L6.5 5L1.5 10Z"
                           fill="#002D63"
                        />
                     </svg>
                  </p>
