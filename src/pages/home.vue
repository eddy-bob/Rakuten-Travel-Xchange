  ...
  <div class="relative">
    ...
    <div class="lg:space-x-2 flex min-h-screen lg:mt-4 lg:px-20">
      ...
      <div class="space-y-1 pb-28 hidden lg:block">
        ...
        <!--  -->
        <section class="rounded-md text-xs shadow-md p-3 space-y-6 bg-white">
        ...
        <section class="text-xs bg-white rounded-lg py-3 px-2 space-y-2">
          ...
          <div class="w-full bg-white px-2 flex space-x-1 border rounded-lg">
            <input
              type="text"
      ...
      <div class="w-full min-h-screen flex flex-col justify-between pb-4">
        ...
        <div class="lg:space-y-2" v-else>
          ...
          <div class="lg:flex space-x-1 text-rakuttenGrey text-xs hidden">
            <div
              class="w-full bg-rakuteenSecondBlue text-center rounded-sm py-3"
            >
          ...
          <div class="">
            <div class="flex space-x-3 bg-white border py-2 px-3 lg:hidden">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
            ...
            <div class="flex w-full lg:hidden">
              ...
              <div class="flex bg-white space-x-4 justify-center py-4 w-1/2">
                <svg
                  width="14"
                  height="16"
                  viewBox="0 0 14 16"
                ...
                <div class="flex lg:flex-row flex-col justify-between w-full">
                  <div class="space-y-2">
                    ...
                    <div class="lg:flex lg:space-x-2 hidden">
                      ...
                      <p class="font-extrabold">Singapore - SG Clean</p>
                    </div>
                  </div>
        ...
        >
          ...
          <div
            class="flex justify-between lg:space-x-6 text-rakuttenGrey lg:pl-4"
          >
            <p>
              <svg
                class="mt-0.5"
            ...
            <p class="bg-rakuteenSecondBlue text-white px-2 py-1 rounded-md">
              1
            </p>
            <p>2</p>
            <p>3</p>
